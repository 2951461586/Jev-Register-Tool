...
│   ├── selftest.py            自测**入口**（145 行）：只做聚合与调度 + 登记完整性元检查
│   ├── tests/                 自测本体（6 个文件 2231 行，282 项，按被测对象分）
